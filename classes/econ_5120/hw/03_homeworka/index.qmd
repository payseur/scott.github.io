...
::: {style="font-size: 15px"}
\(2\) Consider the apple computer trade example in Section 19.5 of the book. Now suppose that because of a new technology, the North becomes even more productive at producing computers: one unit of labor can now produce 20 computers instead of 16.
...
::: {style="font-size: 15px"}
\(3\) Consider the apple computer trade example in Section 19.5 of the book.  Now suppose that because of technology transfer, the South becomes just as productive as the North at producing apples: one unit of labor can now produce 160 apples instead of 100.
