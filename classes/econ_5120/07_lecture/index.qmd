...
-   Long-run: tight monetary policy? Sticky inflation in the short-run ($i_t=R_t$).

-   Instead Volker uses the short-run model.
:::
:::
...
-   If real a higher interest rate is sustained, then output will remain below potential output.
